...
export const Footer = () => {
  return (
    <>
      ...
      <div
        id="icon-box"
        className="bg-yellow-500 z-[100] text-black p-3 rounded-full hover:text-white cursor-pointer fixed lg:bottom right-6 bottom-6 animate-bounce duration-1000"
      >
