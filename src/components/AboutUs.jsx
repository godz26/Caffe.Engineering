    ...
    >
      ...
      >
        ...
        <div className="w-full text-white flex flex-col">
          ...
          <p className="flex items-center text-lg">
            <FaWarehouse className="mr-[15px]" /> Sitio Ylaya, Marigondon LLC
          </p>
          <p className="flex whitespace-pre text-lg">
            PCAB License Number: {"\t34035"}
          </p>
          <p className="flex whitespace-pre text-lg">
            Business Permit Number: {"\t02005861"}
          </p>
          <p className="flex whitespace-pre text-lg">
            Tax Identification Number: {"\t194 - 544 - 054 - 000"}
          </p>
          <p className="flex whitespace-pre text-lg">
            SSS Identification Number: {"\t06 - 1728686 - 4 - 000"}
          </p>
          <p className="flex whitespace-pre text-lg">
            PhilHealth Identification Number: {"\t12000009928"}
          </p>
        </div>
      </motion.div>
      <motion.div
